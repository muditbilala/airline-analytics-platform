  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      <section className="relative flex-1 flex items-center justify-center min-h-screen overflow-hidden">
        ...
        {/* Gradient overlays */}
        <div className="absolute inset-0 z-[1] bg-gradient-to-b from-navy/60 via-transparent to-navy pointer-events-none" />
        <div className="absolute inset-0 z-[1] bg-gradient-to-r from-navy/40 via-transparent to-navy/40 pointer-events-none" />
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            Explore deep analytics across U.S. domestic flights. Uncover delay patterns,
            carrier performance, and operational insights through interactive visualizations
            and AI-powered chat.
          </motion.p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-text-secondary max-w-xl mx-auto">
              From real-time metrics to AI-powered questions, dive into every dimension of airline operations.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Explore delay patterns by hour, carrier, cause, and season with rich visualizations.",
                icon: (
              ...
              },
              {
                ...
                desc: "Full-featured embedded dashboard with cross-filtering and drill-down capabilities.",
                icon: (
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              },
              {
                ...
                desc: "Ask natural language questions about flight data and get instant insights with charts.",
                icon: (
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              >
                <Link
                  to={card.link}
                  className="glass-card glow-border block p-8 hover:bg-navy-light/90 transition-all duration-300 group h-full"
                >
                  ...
                  <h3 className="text-text-bright font-semibold text-lg mb-2">{card.title}</h3>
